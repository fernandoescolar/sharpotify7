...
using Sharpotify7.Library.Util;
...
namespace Sharpotify.Protocol
{
    public class Protocol
    {
        ...
        public Protocol(Session session)
        {
            ...
            this.handlers = new List<ICommandHandler>();
        }
        #endregion
        #region Methods
        /// <summary>
        ...
        public void Connect()
        {
            if (servers == null)
            {
                ...
                servers.Insert(0, new HostnamePortPair("ap.spotify.com", 4070));
                servers.Insert(0, new HostnamePortPair("ap.spotify.com", 80));
                servers.Insert(0, new HostnamePortPair("ap.spotify.com", 443));
            }
                ...
                if (this.session.ServerRandom[1] == 0x01)
                {
                    if ((ret = this.Receive(buffer, 0x11a)) > 0)
                    {
                        ...
                        if ((ret = this.Receive(buffer, paddingLength)) > 0)
                        {
                            ...
                            string msg = ASCIIEncoding.GetString(buffer, 0, ret);
        ...
        public void ReceivePacket()
        {
            try
            {
                ...
                this.client.BeginRead(header, 0, header.Length, OnReceivePacketHeaderReceived);
            }
            catch (Exception ex)
            {
        ...
        protected virtual void OnReceivePacketHeaderReceived(byte[] header)
        {
            ...
            {
			    handler.CommandReceived(command, payload);
		    }
            ReceivePacket();
        }
        /// <summary>
        ...
        /// </summary>
        public void SendAdRequest(IChannelHandler handler, int type)
        {
            /* Create channel and buffer. */
            Channel.Channel channel = new Channel.Channel("Ad-Channel", Channel.ChannelType.TYPE_AD, handler);
        ...
        /// </summary>
        public void SendToplistRequest(IChannelHandler handler, Dictionary<string, string> paramargs)
        {
		    ...
		    /* Create channel and buffer. */
		    Channel.Channel    channel = new Channel.Channel("Toplist-Channel", Channel.ChannelType.TYPE_TOPLIST, handler);
        ...
        /// </summary>
        public void SendImageRequest(IChannelHandler handler, string id)
        {
            /* Create channel and buffer. */
            Channel.Channel channel = new Channel.Channel("Image-Channel", Channel.ChannelType.TYPE_IMAGE, handler);
        ...
        /// </summary>
        public void SendSearchQuery(IChannelHandler handler, string query, int offset, int limit)
        {
            /* Create channel and buffer. */
            byte[] queryBytes = Encoding.UTF8.GetBytes(query);
            Channel.Channel channel = new Channel.Channel("Search-Channel", Channel.ChannelType.TYPE_SEARCH, handler);
        ...
        /// Search music. The response comes as GZIP compressed XML.
        /// </summary>
        public void SendSearchQuery(IChannelHandler handler, string query)
        {
            this.SendSearchQuery(handler, query, 0, -1);
        }
        /// <summary>
        /// Request AES key for a track.
        /// </summary>
        public void SendAesKeyRequest(IChannelHandler handler, Track track, Sharpotify.Media.File file)
        {
            /* Create channel and buffer. */
            Channel.Channel channel = new Channel.Channel("AES-Key-Channel", Channel.ChannelType.TYPE_AESKEY, handler);
        ...
        /// </summary>
        public void SendSubstreamRequest(IChannelHandler handler, Sharpotify.Media.File file, int offset, int length)
        {
            /* Create channel and buffer. */
            Channel.Channel channel = new Channel.Channel("Substream-Channel", Channel.ChannelType.TYPE_SUBSTREAM, handler);
        ...
        /// </summary>
        public void SendBrowseRequest(IChannelHandler handler, int type, List<String> ids)
        { 
            /* Create channel and buffer. */
		    Channel.Channel channel = new Channel.Channel("Browse-Channel", Channel.ChannelType.TYPE_BROWSE, handler);
        ...
        /// </summary>
        public void SendBrowseRequest(IChannelHandler handler, int type, String id)
        {
            List<String> list = new List<String>();
            list.Add(id);
            this.SendBrowseRequest(handler, type, list);
        }
        /// <summary>
        /// Request replacements for a list of tracks. The response comes as compressed XML.
        /// </summary>
        public void SendReplacementRequest(IChannelHandler handler, List<Track> tracks)
        { 
        ...
        /// </summary>
        public void SendPlaylistRequest(IChannelHandler handler, string id)
        {
            /* Create channel and buffer. */
            Channel.Channel channel = new Channel.Channel("Playlist-Channel", Channel.ChannelType.TYPE_PLAYLIST, handler);
        ...
        /// </summary>
        public void SendChangePlaylistContainer(IChannelHandler handler, PlaylistContainer playlistContainer, string xml)
        {
            /* Create channel and buffer. */
            Channel.Channel channel = new Channel.Channel("Change-Playlist-Container-Channel", Channel.ChannelType.TYPE_PLAYLIST, handler);
            byte[] bytes = ASCIIEncoding.GetBytes(xml);
        ...
        /// </summary>
        public void SendChangePlaylist(IChannelHandler handler, Playlist playlist, string xml)
        {
            /* Create channel and buffer. */
            Channel.Channel channel = new Channel.Channel("Change-Playlist-Channel", Channel.ChannelType.TYPE_PLAYLIST, handler);
            byte[] bytes = ASCIIEncoding.GetBytes(xml);
            ByteBuffer buffer = ByteBuffer.Allocate(2 + 16 + 1 + 4 + 4 + 4 + 1 + 1 + bytes.Length);
        ...
        /// </summary>
        public void SendCreatePlaylist(IChannelHandler handler, Playlist playlist, string xml)
        {
            /* Create channel and buffer. */
            Channel.Channel channel = new Channel.Channel("Change-Playlist-Channel", Channel.ChannelType.TYPE_PLAYLIST, handler);
            byte[] bytes = ASCIIEncoding.GetBytes(xml);
        ...
        private void Send(ByteBuffer buffer)
        {
		    try
            {
                ...
                this.client.BeginWrite(buffer.ToArray(), 0, buffer.Limit, EndSend);
		    }
		    catch (IOException e)
            {
        ...
        private int Receive(byte[] bytes, int off, int len)
        {
            ...
            try
            {
                ...
                while ((read != 0) && (totalRead < len))
                {
                    ...
                    read = this.client.Read(bytes, off + totalRead, len - totalRead);
                    totalRead += read;
                }
            }

...
namespace Sharpotify.Protocol
{
    public class Session
    {
        ...
        */
        ...
        public string StringUsername { get { return ASCIIEncoding.GetString(this._username); } }
        ...
        public Protocol Authenticate(string username, string password)
        {
            ...
            this._username = ASCIIEncoding.GetBytes(username);
            this._password = ASCIIEncoding.GetBytes(password);

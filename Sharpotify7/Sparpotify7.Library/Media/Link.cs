    ...
    public class Link
    {
            ...
            get 
            {
                ...
                else if (this.IsSearchLink)
                {
                    try
                    {
                        return string.Format(
                            "spotify:search:%s",
                            /*System.Web.HttpUtility.UrlDecode(*/this._query/*, System.Text.Encoding.UTF8)*/ // Not in phone 7
                        );
                    }
                    catch (Exception e)
                    {
                ...
                else if (this.IsSearchLink)
                {
                    try
                    {
                        return string.Format(
                            ...
                            /*System.Web.HttpUtility.UrlDecode(*/this._query/*, System.Text.Encoding.UTF8)*/ // TODO: ignore in phone 7
                        );
                    }
                    catch (Exception e)
                    {
        ...
        private Link(string uri)
        {
            ...
            else if (searchMatcher.Success)
            {
                ...
                try
                {
                    this._query = /*System.Web.HttpUtility.UrlDecode(*/searchMatcher.Groups[1].Value/*, System.Text.Encoding.UTF8)*/; //TODO: ignore in phone 7
                }
                catch (Exception e)
                {
                    throw new InvalidSpotifyURIException();

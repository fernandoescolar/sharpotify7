namespace Org.Mentalis.Security.Cryptography
{
    ...
    sealed public class SecurityElement
    {
        ...
        internal IList<object> m_lChildren;
        internal IList<object> m_lAttributes;
        ...
        public SecurityElement( String tag )
        {
            ...
            if (!IsValidTag( tag ))
                throw new ArgumentException( String.Format( "Argument_InvalidElementTag %s", tag ) );
        ...
        public SecurityElement( String tag, String text )
        {
            ...
            if (text != null && !IsValidText( text ))
                throw new ArgumentException( String.Format( "Argument_InvalidElementText %s", text ) );
        ...
        public String Tag
        {
            ...
            set
            {
                ...
                if (!IsValidTag( value ))
                    throw new ArgumentException( String.Format( "Argument_InvalidElementTag %s", value ) );
        ...
        public System.Collections.Hashtable Attributes
        {
            ...
            set
            {
                ...
                {
                    List<object> list = new List<object>(value.Count);
                    ...
                    while (enumerator.MoveNext())
                    {
                        ...
                        if (!IsValidAttributeName( attrName ))
                            throw new ArgumentException( String.Format( "Argument_InvalidElementName %s", (String)enumerator.Current ) );
                        
                        if (!IsValidAttributeValue( attrValue ))
                            throw new ArgumentException( String.Format( "Argument_InvalidElementValue %s", (String)enumerator.Value ) );
        ...
        internal void AddAttributeSafe( String name, String value )
        {
            ...
            {
                m_lAttributes = new List<object>( 4 );
            }
            else
            {
                IEnumerator enumerator = m_lAttributes.GetEnumerator();
        ...
        {   
            ...
            if (!IsValidAttributeName( name ))
                throw new ArgumentException( String.Format( "Argument_InvalidElementName %s", name ) );
                
            if (!IsValidAttributeValue( value ))
                throw new ArgumentException( String.Format( "Argument_InvalidElementValue %s", value ) );
        ...
        private static String GetUnescapeSequence( String str, int index, out int newIndex )
        {
            ...
            for (int i = 0; i < s_escapePairs.Length; ++i)
            {
                ...
                if (length <= maxCompareLength && String.Compare( s_escapePairs[i].m_strAttributeValue, 0, str, index, s_escapePairs[i].m_strAttributeValue.Length, CultureInfo.InvariantCulture, CompareOptions.None) == 0)
                {
